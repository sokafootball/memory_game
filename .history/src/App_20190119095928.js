...
class App extends Component {
  ...
  countShowingCards = () => {
    ...
    console.log(`cards counted to ${showingCards}`)
    this.setState({showingCards})
    console.log(`showing cards counter to: ${this.state.showingCards}`)
  }
  ...
  showCard = (clickedCard, id) => {
    if(clickedCard.status === 'hidden' && this.state.showingCards < 2){
      ...
      this.setState({cards: newCards}, console.log(`cards shown ${this.state.cards}`))
      }
    }
